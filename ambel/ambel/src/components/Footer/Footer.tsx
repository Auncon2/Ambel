  ...
  const socialLinks = [
    {
      ...
      src: "/path-to-your-images/twitter-icon.png",
      alt: "Twitter",
    },
    {
      href: "https://www.facebook.com",
      src: "/path-to-your-images/facebook-icon.png",
      alt: "Facebook",
    },
    {
      href: "https://www.instagram.com",
      src: "/path-to-your-images/instagram-icon.png",
      alt: "Instagram",
    },
    {
      href: "https://www.github.com",
      src: "/path-to-your-images/github-icon.png",
      alt: "Github",
    },
    {
      href: "https://www.dribble.com",
      src: "/path-to-your-images/dribble-icon.png",
      alt: "Dribble",
    },
  ];
  const legalLinks = [
      ...
      <div className="w-[1366px]">
        <div className="w-[92%] md:w-[90%] mx-auto">
          ...
          <div className="md:inline-flex md:justify-between w-full text-white py-[32px] border-t border-white/10 text-sm">
            <div className="flex w-full justify-md:justify-between flex-col-reverse md:flex-row gap-5">
